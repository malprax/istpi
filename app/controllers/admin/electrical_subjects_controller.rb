class Admin::ElectricalSubjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @electrical_subject.save
        format.html { redirect_to admin_electrical_subjects_path, notice: 'Electrical subject was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_electrical_subjects_url, notice: 'Electrical subject was successfully destroyed.' }
