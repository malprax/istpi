class Admin::CivilSubjectsController < ApplicationController
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_civil_subjects_url, notice: 'Civil subject was successfully destroyed.' }
