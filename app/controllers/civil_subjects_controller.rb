  ...
  def create
    ...
    respond_to do |format|
      if @civil_subject.save
        format.html { redirect_to @civil_subject, notice: 'Civil subject was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @civil_subject.update(civil_subject_params)
        format.html { redirect_to @civil_subject, notice: 'Civil subject was successfully updated.' }
