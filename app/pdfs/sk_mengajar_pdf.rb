class SkMengajarPdf< Prawn::Document
  ...
  def konsideran1
    ...
    bounding_box([0, cursor], :width => 500, :height => 800) do
        ...
        text_box "   Mengangkat Saudara(i) :  Dian Mahdiansyah, S.Pd, M.T, untuk", :at  => [74,cursor-320], :size  => 12
  ...
  def konsideran2
    #code
    bounding_box([0, cursor], :width => 500, :height => 500, page_sheet: 2) do
        text_box "c. Ketiga :", :at  => [60,cursor-440], :size  => 12
        text_box "   Surat keputusan ini mulai berlaku pada tanggal ditetapkannya, dan", :at  => [74,cursor-460], :size  => 12
        text_box "   apabila terdapat kekeliruan dalam keputusan ini maka akan diperbaiki", :at  => [74,cursor-480], :size  => 12
        text_box "   sebagaimana mestinya", :at  => [74,cursor-500], :size  => 12
    end
  end
  def tandatangan1
    #code
    bounding_box([0, cursor], :width => 500, :height => 500) do
        ...
        move_down 30
        text_box "Ir. A. Arifuddin Iskandar, MP", :at  => [60,cursor-80], :size  => 12
    end
  end
  def tembusan
    #code
    text_box "1. Ketua Yayasan YASPI Makassar"
    move_down 10
    text_box "2. Dekan Teknik IST-Pembangunan Indonesia"
    move_down 10
    text_box "3. Ketua Ketua Prodi IST-Pembangunan Indonesia"
    move_down 10
    text_box "4. Arsip"
    move_down 10
  end
  def lampiran
    #code
    text_box "Lampiran : SK No.         /SK/IST-PI/IX/2016, tentang pengangkata Dosen "
    move_down 10
    text_box "Pengampuh Mata Kuliah Semester ganjil TA 2016/2017 atas nama:"
    move_down 10

  end
  def jadwal
    #code
    text_box "JADWAL PERKULIAHAN IST-PI MAKASSAR, SEMESTER GANJIL "
    move_down 10
    text_box "TAHUN AJARAN 2016/2017"
    move_down 10
    text_box "Tabel"
  ...
  def tandatangan2
    #code
    text_box "Makassar, 1 September 2016"
    move_down 10
    text_box "IST-Pembangunan Indonesia"
    move_down 10
    text_box "Pembantu Rektor I"
    move_down 10
    text_box "Ir. A. Arifuddin Iskandar, MP"
    move_down 10
  end
  def catatan
    #code
    text_box "Catatan"
    move_down 5
    text_box "Diminta agar menyampaikan Rencana Pembelajaran Semester (RPS) dan Satuan Acara"
    move_down 5
    text_box "Perkuliahan (SAP) kepada Prodi masing-masing sebelum perkuliahan dimulai"
    move_down 5
  end

  # def initialize(electricalschedulesubject)
  #   super(top_margin: 30, left_margin: 50, bottom_margin: 30, :page_size  => 'A4')
  #   @electricalschedulesubject = electricalschedulesubject
  #   #isi surat
  #   kopsurat
  #   garis
